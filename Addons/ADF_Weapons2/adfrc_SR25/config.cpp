...
class CfgPatches
{
 class adfrc_sr25
 {
	requiredaddons[] = {"A3_Data_F","A3_UI_F","A3_Anims_F","A3_Anims_F_Config_Sdr","A3_Weapons_F","cba_jr","cba_optics","cba_common","cba_events","adf_weapons2"};
	units[] = {};
	weapons[] = {""};
	magazines[] = {""};
	version="0.5";
