...
class CfgWeapons
{
	...
	class ADFRC_maximi: ADFRC_minimi_BASE
	{
		...
		{
			"OFP2_ManSkeleton",
			"\ADF_Weapons\core\data\anims\Maximi_Standard.rtm"
		};
		...
		rhs_grip1_change = "ADFRC_maximi_GripPod";
		rhs_grip2_change = "ADFRC_maximi_AFG";
		rhs_grip3_change = "ADFRC_maximi_VFG";
	};

	class ADFRC_maximi_GripPod: ADFRC_maximi
	{
		author = "Brucey";
	displayName = "F89 Maximi Grip-Pod";
    Grip_Macro(1,Maximi_VG)
	};
	
	class ADFRC_maximi_AFG: ADFRC_maximi
	{
		author = "Brucey";
	displayName = "F89 Maximi AFG";
    Grip_Macro(2,Minimi_AFG)
	};
	
	class ADFRC_maximi_VFG: ADFRC_maximi
	{
		author = "Brucey";
	displayName = "F89 Maximi VFG";
    Grip_Macro(3,Maximi_VG)
	};
	...
	class ADFRC_maximi_Modern: ADFRC_maximi
	{
		...
		rhs_grip1_change = "ADFRC_maximi_Modern_GripPod";
		rhs_grip2_change = "ADFRC_maximi_Modern_AFG";
		rhs_grip3_change = "ADFRC_maximi_Modern_VFG";
	};

	class ADFRC_maximi_Modern_GripPod: ADFRC_maximi_Modern
	{
		author = "Brucey";
	displayName = "F89 Maximi Modernised Grip-Pod";
    Grip_Macro(1,Maximi_VG)
	};
	
	class ADFRC_maximi_Modern_AFG: ADFRC_maximi_Modern
	{
		author = "Brucey";
	displayName = "F89 Maximi Modernised AFG";
    Grip_Macro(2,Minimi_AFG)
	};
	
	class ADFRC_maximi_Modern_VFG: ADFRC_maximi_Modern
	{
		author = "Brucey";
	displayName = "F89 Maximi Modernised VFG";
    Grip_Macro(3,Maximi_VG)
	};
	...
	class ADFRC_maximi_Modern_Short: ADFRC_maximi
	{
		...
		rhs_grip1_change = "ADFRC_maximi_Modern_Short_GripPod";
		rhs_grip2_change = "ADFRC_maximi_Modern_Short_AFG";
		rhs_grip3_change = "ADFRC_maximi_Modern_Short_VFG";
	};

	class ADFRC_maximi_Modern_Short_GripPod: ADFRC_maximi_Modern_Short
	{
		author = "Brucey";
	displayName = "F89 Maximi Modernised (Short) Grip-Pod";
    Grip_Macro(1,Maximi_VG)
	};
	
	class ADFRC_maximi_Modern_Short_AFG: ADFRC_maximi_Modern_Short
	{
		author = "Brucey";
	displayName = "F89 Maximi Modernised (Short) AFG";
    Grip_Macro(2,Minimi_AFG)
	};
	
	class ADFRC_maximi_Modern_Short_VFG: ADFRC_maximi_Modern_Short
	{
		author = "Brucey";
	displayName = "F89 Maximi Modernised (Short) VFG";
    Grip_Macro(3,Maximi_VG)
	};
	...
	class ADFRC_maximi_Para: ADFRC_maximi
	{
		...
		rhs_grip1_change = "ADFRC_maximi_Para_GripPod";
		rhs_grip2_change = "ADFRC_maximi_Para_AFG";
		rhs_grip3_change = "ADFRC_maximi_Para_VFG";
	};

	class ADFRC_maximi_Para_GripPod: ADFRC_maximi_Para
	{
		author = "Brucey";
	displayName = "F89 Maximi Para Grip-Pod";
    Grip_Macro(1,Maximi_VG)
	};
	
	class ADFRC_maximi_Para_AFG: ADFRC_maximi_Para
	{
		author = "Brucey";
	displayName = "F89 Maximi Para AFG";
    Grip_Macro(2,Minimi_AFG)
	};
	
	class ADFRC_maximi_Para_VFG: ADFRC_maximi_Para
	{
		author = "Brucey";
	displayName = "F89 Maximi Para VFG";
    Grip_Macro(3,Maximi_VG)
	};
	...
	class ADFRC_maximi_Para_Short: ADFRC_maximi
	{
		...
		rhs_grip1_change = "ADFRC_maximi_Para_Short_GripPod";
		rhs_grip2_change = "ADFRC_maximi_Para_Short_AFG";
		rhs_grip3_change = "ADFRC_maximi_Para_Short_VFG";
	};

	class ADFRC_maximi_Para_Short_GripPod: ADFRC_maximi_Para_Short
	{
		author = "Brucey";
	displayName = "F89 Maximi Para (Short) Grip-Pod";
    Grip_Macro(1,Maximi_VG)
	};
	
	class ADFRC_maximi_Para_Short_AFG: ADFRC_maximi_Para_Short
	{
		author = "Brucey";
	displayName = "F89 Maximi Para (Short) AFG";
    Grip_Macro(2,Minimi_AFG)
	};
	
	class ADFRC_maximi_Para_Short_VFG: ADFRC_maximi_Para_Short
	{
		author = "Brucey";
	displayName = "F89 Maximi Para (Short) VFG";
    Grip_Macro(3,Maximi_VG)
	};
