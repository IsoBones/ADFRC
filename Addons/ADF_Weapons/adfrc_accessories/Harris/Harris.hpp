	class ADFRC_Harris: ItemCore
	{
		scope 				= 2;																	/// available in Arsenal
		displayName			= "Harris S-BRMP Bipod";													/// name of item in Inventory (and Arsenal)
		picture				= "\ADF_Weapons\adfrc_accessories\Harris\ui\Gear_MSS_SBRMP_CA.paa";			/// icon in Inventory
		model 				= "\ADF_Weapons\adfrc_accessories\Harris\mss_SBRMP.p3d";						/// path to model
		...
		inertia = 0.17;						/// how much does the bipod add to inertia of the weapon
	};	